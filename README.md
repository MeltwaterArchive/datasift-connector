...
An Historics API server runs by default at `http://[connector-machine]:8888`. Details on how to interact with the API can be found on the [historics-api page]((https://github.com/datasift/datasift-connector/historics-api).
